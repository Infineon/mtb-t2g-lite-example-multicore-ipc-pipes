...
* File Name:   main.c
*
* Description: This is the source code for CM4 in the MultiCore IPC Pipes
...
int main(void)
{
    ...
    for (;;)
    {
        ...
        Cy_IPC_Drv_SendMsgWord(Cy_IPC_Drv_GetIpcBaseAddress(USED_IPC_CHANNEL),(1u << IPC_NOTIFY_INT_NUMBER),u32Led);
